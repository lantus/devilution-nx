...
LIBS      	= -specs=$(DEVKITPRO)/libnx/switch.specs -g -march=armv8-a+crc+crypto -mtune=cortex-a57 -mtp=soft -fPIE -L$(DEVKITPRO)/libnx/lib -L$(DEVKITPRO)/portlibs/switch/lib -lSDL2_mixer -lSDL2 -lSDL2_ttf -lfreetype -lvorbisfile -lvorbis -logg -lmodplug -lmikmod -lmpg123 -lEGL -lglapi -ldrm_nouveau -lpng -lbz2 -lpthread -lz -lnx -lm -lstdc++
...
CXXFLAGS  	= $(CXXINCS) $(DEFINES) -march=armv8-a+crc+crypto -mtune=cortex-a57 -mtp=soft -fPIE -fsigned-char -Wall -Wextra -Wno-write-strings -fpermissive -Wno-write-strings -Wno-multichar -w
CFLAGS    	= $(INCS) $(DEFINES)    -march=armv8-a+crc+crypto -mtune=cortex-a57 -mtp=soft -fPIE -fsigned-char -Wall -Wextra -Wno-write-strings -fpermissive -Wno-write-strings -Wno-multichar -w
GPROF     	= gprof.exe
RM        	= rm -f
OUTPUT    	= diablo-nx
...
obj/fault.o: $(GLOBALDEPS) Source/fault.cpp 
	$(CPP) -c Source/fault.cpp -o obj/fault.o $(CXXFLAGS)
...
obj/logging.o: $(GLOBALDEPS)  Source/logging.cpp
	$(CPP) -c  Source/logging.cpp -o obj/logging.o $(CXXFLAGS)
...
obj/msgcmd.o: $(GLOBALDEPS)  Source/msgcmd.cpp
	$(CPP) -c  Source/msgcmd.cpp -o obj/msgcmd.o $(CXXFLAGS)
...
obj/ddraw.o: $(GLOBALDEPS) SourceX/miniwin/ddraw.cpp
	$(CPP) -c SourceX/miniwin/ddraw.cpp -o obj/ddraw.o $(CXXFLAGS)	
...
obj/tcp_client.o: $(GLOBALDEPS) SourceX/dvlnet/tcp_client.cpp
	$(CPP) -c SourceX/dvlnet/tcp_client.cpp -o obj/tcp_client.o $(CXXFLAGS)	
obj/tcp_server.o: $(GLOBALDEPS) SourceX/dvlnet/tcp_server.cpp
	$(CPP) -c SourceX/dvlnet/tcp_server.cpp -o obj/tcp_server.o $(CXXFLAGS)	
obj/udp_p2p.o: $(GLOBALDEPS) SourceX/dvlnet/udp_p2p.cpp
	$(CPP) -c SourceX/dvlnet/udp_p2p.cpp -o obj/udp_p2p.o $(CXXFLAGS)	
